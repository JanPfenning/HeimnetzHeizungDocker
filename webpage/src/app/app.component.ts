...
export class AppComponent {
  ...
  showDatabaseStatus() {
    ...
    const subscription = this.Service.getDatabaseStatus()
      .subscribe(data => {
  ...
  showApiStatus() {
    this.serverHealth = 0
    const subscription = this.Service.getApiStatus()
      .subscribe(data => {
          //console.log(data)
          this.serverHealth = 1
        }, error => {
  ...
  showWechselrichterStatus() {
    ...
    const subscription = this.Service.getWechselrichterStatus()
      .subscribe(data => {
          //console.log(data)
  ...
  showTpLinkCloudStatus() {
    this.tplinkHealth = 0
    const subscription = this.Service.getTpLinkCloudStatus()
      .subscribe(data => {
          //console.log(data)
  ...
  showSensorStatus(){
    this.sensorHealth = 0
    const subscription = this.Service.getSensorStatus()
      .subscribe(data => {
  ...
  showBrokerStatus() {
    this.brokerHealth = 0
    const subscription = this.Service.getBrokerStatus()
      .subscribe(data => {
          //console.log(data)
